								...
								<div class="sale-num">
									...
									<div class="btn-group dropright">
										...
										<div class="dropdown-menu">
											<a class="dropdown-item" href="report/excel/reporteRifaDobleOportunidad.php" target="_blank">Excel</a>
											<a class="dropdown-item" href="report/pdf/reporteRifaDoble.php" target="_blank">PDF</a>
										</div>
									</div>
								</div>
							</div>
