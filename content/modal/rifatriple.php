                ...
                <form id="registroNumeroTriple">
                    ...
                    <div class="form-control">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input loteria" id="loteriaOne" name="loteria"
                                value="triple Tachira A">
                    ...
                    <div class="form-control">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input loteria" id="loteriaDos" name="loteria"
                                value="triple gana">
