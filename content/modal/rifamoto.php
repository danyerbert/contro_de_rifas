            ...
            <div class="modal-body">
                <form action="" id="registroNumeroMoto">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="numeroMoto" name="numeroMoto" pattern="[0-9]{2,2}"
                            maxlength="2">
                        <span></span>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-control">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="mtMoto1" name="metodoDePagoMoto" class="custom-control-input"
                                value="1">
              ...
              ">Pago Movil</label>
                    ...
                    <div class="form-control">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="mtMoto2" name="metodoDePagoMoto" value="2"
                                class="custom-control-input" onclick="javascript: var ch=document.getElementById('ReferenciaPagoMovilMoto');ch.style.display='none';
              ...
              ">
                    ...
                    <div class="form-control">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="mtMoto3" name="metodoDePagoMoto" value="3"
                                class="custom-control-input" onclick="javascript: var ch=document.getElementById('cantidadDivisasMoto');ch.style.display='none';
                var ch2=document.getElementById('cantidadBolivaresMoto');ch2.style.display='inline'
                var ch3=document.getElementById('ReferenciaPagoMovilMoto');ch3.style.display='none' ; 
              ">
                    ...
                    <div class="form-group" id="ReferenciaPagoMovilMoto" style="display:none">
                        ...
                        <input type="text" class="form-control" id="ReferenciaPagoMovilNA" name="ReferenciaPagoMovilNA"
                            pattern="[0-9]" maxlength="20">
                        <label for="montoBolivaresNA">Monto en bolivares</label>
                        <input type="text" class="form-control" name="montoBolivaresNA" id="montoBolivaresNA">
                    </div>
                    <div class="form-group" id="cantidadDivisasMoto" style="display:none">
                        ...
                        <input type="text" class="form-control" id="cantidadDivisasNA" name="cantidadDivisasNA"
                            pattern="[0-9]" maxlength="20">
                    </div>
                    <div class="form-group" id="cantidadBolivaresMoto" style="display:none">
                        ...
                        <input type="text" class="form-control" id="cantidadBolivaresNA" name="cantidadBolivaresNA"
                            pattern="[0-9]" maxlength="20">
                    </div>
