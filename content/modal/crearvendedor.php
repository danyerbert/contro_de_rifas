            ...
            <div class="modal-body">
                <form action="" id="crearVendedor1">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="cedulaVendedor" name="cedulaVendedor"
                            pattern="[0-9]{7,8}">
                    </div>
                    <div class="form-group">
                        <label for="nombreApellido">Nombre</label>
                        <input type="text" class="form-control" id="nombre" name="nombre" pattern="[a-zA-Z\s]{4,20}">
                    </div>
                    <div class="form-group">
