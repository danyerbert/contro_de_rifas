        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nombreApellidoDoble" name="nombreApellidoDoble"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="numeroDoble" name="numeroDoble" pattern="[0-9]{2,2}"
                        maxlength="3">
                    <span></span>
                </div>
                ...
                <div class="form-control">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="mtRoyal1" name="metodoDePagoRoyal" class="custom-control-input"
                            value="1">
              ...
              ">Pago Movil</label>
                ...
                <div class="form-control">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="mtRoyal2" name="metodoDePagoRoyal" value="2"
                            class="custom-control-input" onclick="javascript: var ch=document.getElementById('ReferenciaPagoMovilRoyal');ch.style.display='none';
              ...
              ">
                ...
                <div class="form-control">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="mtRoyal3" name="metodoDePagoRoyal" value="3"
                            class="custom-control-input" onclick="javascript: var ch=document.getElementById('cantidadDivisasRoyal');ch.style.display='none';
                var ch2=document.getElementById('cantidadBolivaresRoyal');ch2.style.display='inline'
                var ch3=document.getElementById('ReferenciaPagoMovilRoyal');ch3.style.display='none' ; 
              ">
                ...
                <div class="form-group" id="ReferenciaPagoMovilRoyal" style="display:none">
                    ...
                    <input type="text" class="form-control" id="ReferenciaPagoMovilRoyala"
                        name="ReferenciaPagoMovilRoyala" pattern="[0-9]" maxlength="20">
                    <label for="montoBolivaresRoyala">Monto en bolivares</label>
                    <input type="text" class="form-control" name="montoBolivaresRoyala" id="montoBolivaresRoyala">
                </div>
                <div class="form-group" id="cantidadDivisasRoyal" style="display:none">
                    ...
                    <input type="text" class="form-control" id="cantidadDivisasRoyala" name="cantidadDivisasRoyala"
                ...
                <div class="form-group" id="cantidadBolivaresRoyal" style="display:none">
                    ...
                    <input type="text" class="form-control" id="cantidadBolivaresROYALa" name="cantidadBolivaresROYALa"
                        pattern="[0-9]" maxlength="20">
                </div>
