            ...
            <div class="modal-body">
                <form id="rifamillonaria">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="cedulaMillonaria" name="cedulaMillonaria"
                            pattern="[0-9]{8}">
                    </div>
                    <div class="form-group">
                        <label for="nombreMillonaria" class="col-form-label">Nombre</label>
                        <input type="text" class="form-control" id="nombreMillonaria" name="nombreMillonaria"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="numeroMillonario1" name="numeroMillonario1"
                            pattern="[0-9]{3}" maxlength="3" minlength="3">
                    </div>
                    <div class="form-group">
                        <label for="numeroMillonario2" class="col-form-label">Numero 2</label>
                        <input type="text" class="form-control" id="numeroMillonario2" name="numeroMillonario2"
                            pattern="[0-9]{3}" maxlength="3" minlength="3">
                    </div>
                    <div class="form-group">
                        <label for="numeroMillonario3" class="col-form-label">Numero 3</label>
                        <input type="text" class="form-control" id="numeroMillonario3" name="numeroMillonario3"
                            pattern="[0-9]{3}" maxlength="3" minlength="3">
                    </div>
                    <div class="form-group">
                        <label for="numeroMillonario4" class="col-form-label">Numero 4</label>
                        <input type="text" class="form-control" id="numeroMillonario4" name="numeroMillonario4"
                            pattern="[0-9]{3}" maxlength="3" minlength="3">
                    </div>
                    <div class="form-group">
                        <label for="numeroMillonario5" class="col-form-label">Numero 5</label>
                        <input type="text" class="form-control" id="numeroMillonario5" name="numeroMillonario5"
                            pattern="[0-9]{3}" maxlength="3" minlength="3">
                    </div>
                    <br>
                    ...
                    <div class="form-control">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="mtMillonaria1" name="metodoDePagoMillo" class="custom-control-input"
                                value="1">
              ...
              ">Pago Movil</label>
                    ...
                    <div class="form-control">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="mtMillonaria2" name="metodoDePagoMillo" value="2"
                                class="custom-control-input" onclick="javascript: var ch=document.getElementById('ReferenciaPagoMovilMillonaria');ch.style.display='none';
              ...
              ">
                    ...
                    <div class="form-control">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="mtMillonaria3" name="metodoDePagoMillo" value="3"
                                class="custom-control-input" onclick="javascript: var ch=document.getElementById('cantidadDivisasMillonaria');ch.style.display='none';
                var ch2=document.getElementById('cantidadBolivaresMillonaria');ch2.style.display='inline'
                var ch3=document.getElementById('ReferenciaPagoMovilMillonaria');ch3.style.display='none' ; 
              ">
                    ...
                    <div class="form-group" id="ReferenciaPagoMovilMillonaria" style="display:none">
                        ...
                        <input type="text" class="form-control" id="ReferenciaPagoMovilMi" name="ReferenciaPagoMovilMi"
                            pattern="[0-9]" maxlength="20">
                        <label for="montoBolivaresMi">Monto en bolivares</label>
                        <input type="text" class="form-control" name="montoBolivaresMi" id="montoBolivaresMi">
                    </div>
                    <div class="form-group" id="cantidadDivisasMillonaria" style="display:none">
                        ...
                        <input type="text" class="form-control" id="cantidadDivisasMi" name="cantidadDivisasMi"
                            pattern="[0-9]" maxlength="20">
                    </div>
                    <div class="form-group" id="cantidadBolivaresMillonaria" style="display:none">
                        ...
                        <input type="text" class="form-control" id="cantidadBolivaresMi" name="cantidadBolivaresMi"
                            pattern="[0-9]" maxlength="20">
                    </div>
                    <input type="hidden" name="vendedorMillonario" id="vendedorMillonario"
