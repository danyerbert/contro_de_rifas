<!-- Modal -->
<div class="modal fade" id="rifaTriplePrueba2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="registroNumeroTriple" action="php/registroTriplePrueba.php" method="POST">
                    ...
                    <div class="form-row align-items-center">
                        <div class="col-sm-4 my-1">
                            ...
                            <input type="text" class="form-control" id="numeroTriple" name="numeroTriple[]"
                                pattern="[0-9]{3,3}" maxlength="3" placeholder="numero">
                        </div>
                        ...
                        <div class="col-auto my-1">
                            <div class="form-check">
                                ...
                                <select class="custom-select mr-sm-2" id="loteria" name="loteria[]">
                                    <option selected value="0" disabled>Loteria...</option>
              ...
              ">
                    ...
                    <div class="form-group" id="ReferenciaPagoMovilTriple500" style="display:none">
                        ...
                        <input type="text" class="form-control" id="ReferenciaPagoMovilTri"
                            name="ReferenciaPagoMovilTri" pattern="[0-9]{4,4}" maxlength="4">
