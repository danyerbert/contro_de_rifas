...
if ($_POST) {
    ...
    switch ($formato) {
        case 1:
            header("location: ../report/pdf/reporteRifaMilloPDF.php?fd=$fechaDesde&fh=$fechaHasta&mdp=$metodoPago&r=$rol");
            break;
        case 2:
            header("location: ../report/excel/reporteRifaMilloExcel.php?fd=$fechaDesde&fh=$fechaHasta&mdp=$metodoPago&r=$rol");
            break;
