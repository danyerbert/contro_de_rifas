...
if ($_POST) {
    ...
    switch ($formato) {
        case 1:
            header("location: ../report/pdf/reporteRifaRoyalPDF.php?fd=$fechaDesde&fh=$fechaHasta&mdp=$metodoPago&r=$rol");
            break;
        case 2:
            header("location: ../report/excel/reporteRifaRoyalExcel.php?fd=$fechaDesde&fh=$fechaHasta&mdp=$metodoPago&r=$rol");
            break;
