...
if ($_POST) {
    ...
    switch ($formato) {
        case 1:
            header("location: ../report/pdf/reporteAcumuladoPDF.php?fd=$fechaDesde&fh=$fechaHasta&r=$rol");
            break;
        case 2:
            header("location: ../report/excel/reporteAcumuladoExcel.php?fd=$fechaDesde&fh=$fechaHasta&r=$rol");
            break;
