...
if ($_POST) {
    ...
    switch ($formato) {
        case 1:
            header("location: ../report/pdf/reporteRifaMotoPDF.php?fd=$fechaDesde&fh=$fechaHasta&mdp=$metodoPago&r=$rol");
            break;
        case 2:
            header("location: ../report/excel/reporteRifaMotoExcel.php?fd=$fechaDesde&fh=$fechaHasta&mdp=$metodoPago&r=$rol");
            break;
